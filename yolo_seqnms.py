...
if __name__ == "__main__":
    ...
    parser.add_argument('--Seq_Nms', type=int, default=1, help="If 0 the Seq-NSM won't be use.")
    parser.add_argument('--Nms', type=int, default=0, help="If 0 the Nms won't be use.")
    ...
    if args.Nms == 0:
        ...
        res = yolo_detection.detect_imgs(pkllist, thresh=0.25)
    ...
    boxes, classes, scores = dsnms(res, Seq_Nms=args.Seq_Nms)
    nms_end=time.time()
